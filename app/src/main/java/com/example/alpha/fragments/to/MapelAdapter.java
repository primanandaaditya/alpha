...
public class MapelAdapter extends BaseAdapter {

    Context context;
    List<HomeModel> homeModels;

    public MapelAdapter(Context context, List<HomeModel> homeModels) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(R.layout.menu_mapel, null);
        }
